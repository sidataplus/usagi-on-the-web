...
pub enum ErrorCode {
    ...
    SignatureNonceReplayed,
    SignatureBodyHashMismatch,
    SignatureInvalid,
    EmbeddingFailed,
    TachiomFailed,
    InternalError,
...
impl ErrorCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::SignatureVersionUnsupported => "SIGNATURE_VERSION_UNSUPPORTED",
            Self::SignatureTimestampInvalid => "SIGNATURE_TIMESTAMP_INVALID",
            Self::SignatureNonceReplayed => "SIGNATURE_NONCE_REPLAYED",
            Self::SignatureBodyHashMismatch => "SIGNATURE_BODY_HASH_MISMATCH",
